# -*- coding: utf-8 -*-
"""재학습된 exaone3.5-lora:v2(completion-only loss, max_length 자동확장, epoch 자동선택,
...
ROOT = C.ROOT
OUT = Path("/private/tmp/claude-501/-Users-gyuyeong-projects/ec6664da-8b58-4864-8794-7da1b8965774/scratchpad/exaone_v2_final_results.jsonl")
N_SAMPLE = 30
START_FROM = 0
...
def main():
    ...
    pipeline = Pipeline(index, local=True, local_model="exaone3.5-lora:v2")
    remaining = questions[START_FROM:]
    print(f"[3/3] {len(remaining)}건 EXAONE v2(재학습) 답변 생성 + 채점...", flush=True)
